          ...
          <div className="flex flex-col gap-6 justify-center">
            <div className="relative group overflow-hidden rounded-[2.5rem] bg-academic-navy p-6 text-white shadow-2xl transition-all hover:shadow-premium h-full flex flex-col justify-center">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="relative mb-8 flex h-[296px] w-[296px] items-center justify-center rounded-[3rem] bg-white p-6 shadow-2xl ring-[12px] ring-white/5 transition-transform group-hover:scale-105 duration-500">
                  <Image src="/logo1.png" alt="Logo" fill className="object-contain p-4" />
                </div>
