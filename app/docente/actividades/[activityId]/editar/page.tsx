        ...
        <div className="grid gap-3">
          <form action={updateActivityAction} className="grid gap-3">
            ...
            <Card className="border border-academic-gold/5 shadow-sm rounded-xl p-4 bg-white">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-end gap-4 border-t border-academic-gold/5 pt-6">
                <Button type="submit" className="h-10 rounded-lg bg-academic-navy px-10 text-sm font-bold tracking-tight hover:-translate-y-0.5 shadow-md transition-all text-white border-none">
          ...
          {/* FORMULARIO DE ELIMINACIÓN (FUERA DEL PRINCIPAL) */}
